...
import { Image, Video, Camera, Play } from 'lucide-react';
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-surface-400 text-lg max-w-xl mx-auto">
            One tool for all your Instagram content.
          </p>
        </motion.div>
            ...
            return (
              ...
              >
                ...
                {platform.description && (
                  <span className="text-[10px] font-medium text-surface-400 bg-surface-800/50 px-2 py-0.5 rounded-full">
                    {platform.description}
                  </span>
                )}
              </div>
